...
$kat = $this->MasterTransaksiModel->getKategori();
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Rekap Transaksi <span
                            class="badge badge-info"><?=$this->session->userdata("NAMA_LENGKAP")?></span>
                    </h1>
                        ...
                        <div class="col-xl-4 col-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Transfer
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?=$Chat['total_transfer'];?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-4 col-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Cash on
                                                Delivery
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$Chat['total_cod'];?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Informasi!</strong> ada <?=$Chat['total_batal'];?> orang pelanggan yang belum
                                closing dari transaksi keseluruhan.
...
foreach ($Trans as $Trans): ?>
                                        <tr>
                                            <td><?=$no++;?></td>
                                            <td><?=$Trans['tgl_rekam'];?></td>
                                            <td><?=$Trans['id_penjualan'];?></td>
                                            <td><?=$Trans['total_chat'];?></td>
                                            <td><?=$Trans['total_closing'];?></td>
                                            <td><?=round($Trans['total_closing']*100/$Trans['total_chat'])."%";?></td>
                                            <td>
                                                <a href="<?=site_url('Rekap/cetakLaporan?id=' . $Trans['id_penjualan'] . "&tgl=" . $Trans['tgl_rekam']);?>"
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Isi nama disini..">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control">
                                        <option selected>Pilih</option>
                                        <option value="Hijab Hanin">Hijab Hanin</option>
                                        <option value="Hijab Alila">Hijab Alila</option>
                                        <option value="Hijab Suneo">Hijab Suneo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label>Warna :</label>
                                    <input type="text" class="form-control" placeholder="Masukan warna..">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label>Jumlah :</label>
                                    <input type="number" class="form-control" placeholder="Contoh: 4">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Nama Pembeli :</label>
                                    <input type="text" class="form-control" value="Lerian">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Nama Produk :</label>
                                    <select class="form-control">
                                        <option selected>Hijab Suneo</option>
                                        <option value="Hijab Hanin">Hijab Hanin</option>
                                        <option value="Hijab Alila">Hijab Alila</option>
                                        <option value="Hijab Suneo">Hijab Suneo</option>
                                    </select>
