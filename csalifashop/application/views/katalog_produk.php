            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url();?>penjualan/">Laporan Transaksi</a>
                        <a class="collapse-item" href="<?= base_url();?>belanja">Penjualan</a>
                    </div>
                </div>
            </li>
...
<div class="row">
    <!-- Chat: Today -->
    <?php foreach($jumProduk as $jumProduk):?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$jumProduk["a"];?></div>
                    </div>
                    <div class="col-auto">
...
<?php endforeach;?>
    <!-- Chat: Today -->
    <?php foreach($jumKategori as $jumKategori):?>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$jumKategori["a"];?></div>
                    </div>
                    <div class="col-auto">
...
<?php endforeach;?>
    <!-- Chat: Today -->
    <?php foreach($produkTerlaris as $produkTerlaris):?>
    <div class="col-xl-4 col-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Produk Terlaris
                        </div>
