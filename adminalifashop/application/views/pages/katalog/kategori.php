...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#tambahKategori"><i
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Isi kategori disini.." name="nama_kategori" id="nama_kategori" required="required">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Harga :</label>
                                    <input type="number" class="form-control" id="number" placeholder="Harga" name="harga" required="required" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="0">
                                </div>
                            </div>
                        </div>
    ...
    <!-- Modal Tambah CS -->
    <div class="modal fade" id="editKategori" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
