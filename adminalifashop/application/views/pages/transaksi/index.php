...
<head>
    ...
    function tampilTabel(){
        var url = "<?=site_url('Transaksi/ShowData');?>";
            $.ajax({
                url: url,
                type: 'POST',
                success: function(data) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Daftar Rekap Transaksi</h1>

                    <div class="row">
                        <?php foreach($tmpl as $tmpl): ?>
                        <!-- Chat: Today -->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$tmpl["TOTAL_TRANSAKSI"];?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$tmpl["TOTAL_TRANSFER"];?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$tmpl["TOTAL_COD"];?></div>
                                        </div>
                                        <div class="col-auto">
